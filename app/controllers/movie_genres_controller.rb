class MovieGenresController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movie_genre.save
        format.html { redirect_to movie_genres_path, notice: "Movie genre was successfully created." }
      else
  ...
  def update
    respond_to do |format|
      if @movie_genre.update(movie_genre_params)
        format.html { redirect_to movie_genres_path, notice: "Movie genre was successfully updated." }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to movie_genres_path, notice: "Movie genre was successfully destroyed." }
    end
  end
